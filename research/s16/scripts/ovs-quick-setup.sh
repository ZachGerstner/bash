...
echo 'Checking topology connections...'
ping -c 3 $PARTNER_IP

echo 'Sleep 5 seconds should connection to Partner is not responding.'
sleep 5
...
echo 'Note: Agent runs silently, no output will be printed to STDOUT'
